...
DATA(lv_refinery) = CONV char3( COND #( WHEN is_defect->refinery EQ '1000' THEN 'ONE'
                                        WHEN is_defect->refinery EQ '1100' THEN 'TWO'
                                        WHEN is_defect->refinery EQ '1200' THEN 'THR' ) ).
